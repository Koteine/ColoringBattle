...
58. «Инверсия легенды»: Выбери два цвета в палитре (например, самый светлый и самый тёмный, или розовый и зелёный) и поменяй их местами. Раскрась всю страницу, строго соблюдая этот коварный обмен! (Кодовое слово: Инверсия)
59. «Ограниченный тираж»: Выбери страницу, где в палитре (легенде) ровно 15 или более цветов. Твоя задача — исключить из работы 3 любых оттенка, заменив их на те, что уже есть в палитре. Посмотрим, как изменится иллюстрация! (Кодовое слово: Лимит)
60. «Винтажный фильтр»: Замени все яркие неоновые и сочные цвета из легенды на их пастельные, приглушенные или «грязные» аналоги. Сделай картинку в стиле старой винтажной открытки. (Кодовое слово: Винтаж)
61. «Массовка в сборе»: Найди страницу по номерам, где на заднем плане запрятано маленькое животное, птичка или второстепенный персонаж (который не является главным героем кадра). Проработай его с особой любовью! (Кодовое слово: Массовка)
62. «Главный злодей»: Найди страницу, на которой изображен отрицательный персонаж. Пришли готовый результат — злодеи тоже заслуживают сочных маркеров! (Кодовое слово: Злодей)
63. «Архитектор кадра»: Найди страницу, где более 30% пространства занимают здания, замки, интерьер или элементы архитектуры. (Кодовое слово: Архитектор)
64. «Неоновый акцент»: Раскрась всю страницу по номерам карандашами, а один самый важный элемент (например, магию, глаза персонажа или его корону) сделай вырвиглазным неоновым маркером. Нужно же куда то использовать это безобразие (Кодовое слово: Неон)
65. «Фоновый переворот»: В раскрасках по номерам часто бывает огромный чёрный фон, который съедает кучу маркеров. Твоя задача найти иллюстрацию, где фон должен быть чёрным — сделай его белоснежным (или черным)! А если фон должен быть светлым — закрась его чёрным, тёмным линером или пастелью. (Кодовое слово: Переворот)
66. «Второстепенный герой»: Найди страницу, где главный герой кадра — это не принцесса и не культовый персонаж, а его верный друг, помощник или питомец. Раскрась его с особым вниманием! (Кодовое слово: Помощник)
67. «Магия в воздухе»: Найди иллюстрацию, на которой происходит какое-то волшебство: летят искры, колдует ведьма, светится заклинание или фея машет палочкой. Сделай этот магический элемент самым ярким на странице! (Кодовое слово: Магия)
68. «Эмоциональный взрыв»: Найди страницу, где персонаж крупным планом выражает сильную эмоцию: злится, громко смеется, плачет или сильно удивлен (с открытым ртом или огромными глазами). (Кодовое слово: Эмоция)
69. «Металлический блеск»: Найди страницу, где у персонажей есть доспехи, корона, мечи, монеты, украшения или любые металлические предметы. Твоя задача — раскрасить их так, чтобы они выглядели металлическими (используй блестящие гелевые ручки, металлизированные маркеры или сделай крутые блики белой ручкой). (Кодовое слово: Металл)
70. «Текстурный бунт»: Выбери элемент одежды персонажа (платье, плащ, рубашку) или шерсть животного. Вместо сплошного закрашивания цветом, заполни эти номера текстурой: точечками (дотс), мелкими полосками, штриховкой или чешуйками. (Кодовое слово: Текстура)
71. «Вспышка слева»: Выбери страницу, где есть явный фон и персонаж. Твоя задача — раскрасить самого персонажа строго по номерам, а на фоне закрасить только те ячейки, которые соприкасаются с краем страницы. Центр фона оставь белым! Получится крутой эффект виньетки. (Кодовое слово: Виньетка)
72. «Время обеда»: Найди иллюстрацию, где в кадре присутствует еда или посуда (яблоко Белоснежки, спагетти Леди и Бродяги, чаепитие Безумного Шляпника или суп Рататуя). Сделай этот элемент главным акцентом. (Кодовое слово: Вкусно)
73. «В лучах заката»: Найди страницу, где действие мультфильма происходит ночью или вечером (виден свет фонарей, костёр, звёзды или луна). Добавь на готовую работу блики жёлтой или белой ручкой там, где падает свет. (Кодовое слово: Сумерки)
74. «Магия металлика»: Выбери страницу, где у персонажа есть глаза (то есть почти любую!). Раскрась всю страницу по номерам, но радужку глаз персонажа сделай металлическим или перламутровым маркером/ручкой, чтобы взгляд буквально гипнотизировал. (Кодовое слово: Взгляд)
75. «Неоновый контур»: Раскрась всю страницу как обычно, но вместо финальной обводки чёрным цветом, возьми самый яркий неоновый лайнер (салатовый, розовый или оранжевый) и обведи им главного героя по внешнему контуру. Получится эффект неонового свечения! (Кодовое слово: Неон)
76. «Этот забавный полубог с волшебным рыболовным крюком умеет превращаться в гигантского сокола, но никак не может запомнить, что спасать человечество нужно без лишнего хвастовства». (Ответ и кодовое слово — задача на этап)
